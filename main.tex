...
\begin{table}[!ht]
    ...
    \hline
        Metric & Ag/AgCl & \gls{EMS} & Gold \\ \hline
...
%\textbf{Application Implications:} The choice between Ag/AgCl and gold-plated electrodes for pulse measurements should consider both the monitoring location and the specific requirements of the application. For upper arm measurements where higher \gls{SNR} is a priority, gold-plated electrodes appear to offer an advantage. Conversely, for chest measurements, the choice may depend on the balance between the need for slightly higher \gls{SNR} (favoring Ag/AgCl electrodes) and faster settling times (favoring gold-plated electrodes). The unavailability of data for \gls{EMS} electrodes in pulse measurements suggests a limitation in their utility for reliable cardiovascular monitoring, highlighting the need for further research into electrode designs that can accommodate a broader range of measurement scenarios.
...
%\textbf{Upper Arm vs. Chest Measurements:} The experimental results highlight a stark difference in performance among the electrode types when used for pneumography. Notably, gold-plated electrodes exhibited superior \gls{SNR} in chest measurements with a value of 30, significantly outperforming both Ag/AgCl and \gls{EMS} electrodes. This suggests that gold-plated electrodes are more adept at capturing the subtle changes in \gls{BioZ} caused by breathing at the chest level, attributed to their enhanced conductivity and biocompatibility. However, in the upper arm scenario, the performance of gold-plated electrodes was the lowest with an \gls{SNR} of 5, which could be due to the reduced impact of thoracic movement on \gls{BioZ} at this location.
...
%\textbf{Upper Arm Measurements:} In contrast, for upper arm measurements, \gls{EMS} electrodes demonstrated an immediate settling time of 0 seconds, suggesting that despite their lower SNR, they may offer advantages in scenarios where rapid setup and less precise respiratory monitoring are acceptable.
...
%\textbf{Comparative Analysis:} The experimental findings indicated that Ag/AgCl electrodes exhibited the lowest \gls{CER} at 3.30\%, followed by \gls{EMS} electrodes at 5.20\%, and gold-plated electrodes at 5.50\%. This suggests that Ag/AgCl electrodes provide a more stable and reliable channel for body-coupled communication, likely due to their effective impedance matching with human skin, which is critical for minimizing signal loss and reflections.
...
%    \item Exploring the impact of electrode size, shape, and placement on measurement accuracy and user comfort in \gls{BioZ} and \gls{BCC} applications.
...
%\end{enumerate}
%In conclusion, this study provides valuable insights into the comparative performance of different electrode types in \gls{BioZ} measurements and \gls{BCC} applications. By highlighting the strengths and limitations of Ag/AgCl, \gls{EMS}, and gold-plated electrodes, we contribute to the informed selection of electrode materials in the development of advanced biomedical devices. The pursuit of optimized electrode solutions remains a critical endeavor as we advance towards more accurate, reliable, and user-friendly non-invasive diagnostic and communication technologies in healthcare.
